if(global.died){
	...
	"Again, and again, and again, and again, and again...", "Will people REALLY read this?");
    }

}else{

	if global.in_hud == false{
